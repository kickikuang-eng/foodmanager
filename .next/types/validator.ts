...
// Validate ../../src/app/dashboard/(routes)/scrape/page.tsx
{
  const handler = {} as typeof import("../../src/app/dashboard/(routes)/scrape/page.js")
  handler satisfies AppPageConfig<"/dashboard/scrape">
}
